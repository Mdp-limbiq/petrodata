/* EMPRESAS REALES de vacamuerta.io/companies — scrape del 2026-08-11.
   ...
   `website` alimenta el favicon del logo, igual que CompanyLogo en producción.
...
export const COMPANIES: Company[] = [
  ...
  c(7, 'roch_sa', 'ROCH S.A.', 0.3, 0.4, 1123),
  ...
  c(12, 'aconcagua', 'Petrolera Aconcagua Energía S.A.', 0.5, 0.7, 722),
  c(13, 'crown_point', 'CROWN POINT ENERGIA S.A.', 0.3, 0.6, 697),
  ...
  c(16, 'oilstone_energia_sa', 'OILSTONE ENERGIA S.A.', 0.3, 0.2, 491),
  ...
  c(30, 'edhipsa', 'EDHIPSA', 0.0, 0.0, 41),
  ...
  c(34, 'emesa', 'E.M.E.S.A', 0.0, 0.0, 29),
  ...
  c(41, 'medanito', 'MEDANITO S.A.', 0.0, 0.0, 15),
